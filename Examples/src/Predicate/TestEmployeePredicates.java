...
public class TestEmployeePredicates
{
    public static void main(String[] args)
    {
        ...
        System.out.println("More than 35: " + filterEmployees(employees, isAgeMoreThan(35)) );

        //Employees other than above collection of "isAgeMoreThan(35)"
        //can be get using negate()
        System.out.println("Less than 35: "  + filterEmployees(employees, isAgeMoreThan(35).negate()));
    }
}
